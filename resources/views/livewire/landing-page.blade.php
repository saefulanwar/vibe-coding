    ...
    <main class="flex-grow">
        ...
        <section class="py-16 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-slate-900">{{ __('Mengapa Belajar Bersama Kami?') }}</h2>
                    <p class="mt-4 text-lg text-slate-600">{{ __('Platform kursus unggulan yang dirancang untuk kesuksesan karir Anda.') }}</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 hover:shadow-lg transition duration-300">
                        ...
                        <h3 class="text-xl font-semibold text-slate-900 mb-2">{{ __('Sertifikat Resmi') }}</h3>
                        <p class="text-slate-600">{{ __('Dapatkan sertifikat kompetensi resmi setelah menyelesaikan kursus yang diakui industri.') }}</p>
                    </div>
                    <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 hover:shadow-lg transition duration-300">
                        ...
                        <h3 class="text-xl font-semibold text-slate-900 mb-2">{{ __('Instruktur Ahli Unit') }}</h3>
                        <p class="text-slate-600">{{ __('Belajar langsung dari para praktisi dan akademisi terbaik di fakultas masing-masing.') }}</p>
                    </div>
                    <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 hover:shadow-lg transition duration-300">
                        ...
                        <h3 class="text-xl font-semibold text-slate-900 mb-2">{{ __('Akses Selamanya') }}</h3>
                        <p class="text-slate-600">{{ __('Sekali mendaftar, Anda bisa mengakses materi kursus kapan saja dan di mana saja tanpa batas.') }}</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="bg-gradient-to-r from-blue-900 to-indigo-900 py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-3xl font-bold text-white mb-4">{{ __('Siap Untuk Meningkatkan Skil Anda?') }}</h2>
                <p class="text-xl text-indigo-100 mb-8 max-w-2xl mx-auto">{{ __('Bergabunglah dengan ribuan siswa lainnya yang sudah meraih kesuksesan bersama platform kursus GLACIER.') }}</p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                <div class="col-span-1 md:col-span-2">
                    ...
                    <p class="mt-4 text-slate-400 max-w-sm">{{ __('Platform pembelajaran daring terbaik untuk karir masa depan Anda.') }}</p>
                </div>
                <div>
                    <h3 class="text-white font-semibold mb-4">{{ __('Navigasi') }}</h3>
                    <ul class="space-y-2 text-slate-400">
                        <li><a href="#" class="hover:text-white transition">{{ __('Beranda') }}</a></li>
                        <li><a href="#" class="hover:text-white transition">{{ __('Katalog Kursus') }}</a></li>
                        <li><a href="#" class="hover:text-white transition">{{ __('Fakultas & Unit') }}</a></li>
                        <li><a href="#" class="hover:text-white transition">{{ __('Tentang Kami') }}</a></li>
                    </ul>
                </div>
                <div>
